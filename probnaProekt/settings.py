"""
Django settings for probnaProekt project.
...
SECRET_KEY = 'django-insecure-9)v8=bc3h%tobf%lf#(!#_!f+qttcs^d7*33t*7uc69cd#!t1j'
...
WSGI_APPLICATION = 'probnaProekt.wsgi.application'
